...
if content_loaded:
    ...
    if content_loaded:
        ...
        if updated_model_choice.startswith("Real vs Fraud Car Detection"):
            ...
            input_folder = r"C:\Users\Adarsh Nema\Desktop\hackathon\WNS\test\test\images"  # Replace with the actual path to your folder containing the images
            ...
            if uploaded_file is not None:
                ...
                for index, row in df.iterrows():
                    image_filename = row['filename']  # Update this line to match the column name in your CSV file
                    full_image_path = f"{input_folder}\\{image_filename}"  # Adjust this line based on your folder structure
                    ...
                    if real_probability > 0.73:
                        ...
                        df.at[index, 'prediction'] = 1  # Update 'prediction' column to 1 for fraud
